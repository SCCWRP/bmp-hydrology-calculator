...
<div style="text-align: center; max-width: 600px; margin: auto;">
  <img src="https://github.com/user-attachments/assets/e7dacb8c-879c-4ff4-b77c-5009aa681e5e" style="max-width: 100%;" />
  <div style="margin-top: 8px;">
    Figure 1: Example infiltration data visualization generated by the Infiltration Analysis calculator. Data from three separate piezometers installed in the same BMP.
  </div>
</div>
<br>
