...
*Figure 3: Example BMP Schematic with inflow from two drainage areas (Q_{in1}, Q_{in2}), one outflow (Q_{out}), and one bypass (Q_{byp}) flowrate timeseries.*
...
*Figure 5: Example infiltration data visualization generated by the Infiltration Analysis calculator. Data from two separate piezometers installed in the same BMP.*
